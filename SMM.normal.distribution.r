##Smoothing mixture model using data with normal distribution
...
##1) exposure: "age"
##2) outcome: "bmi"
##3) covariates: these can be included in the "gamm4" model directly
...
bmi_guts <- read.csv(file="simulated.normal.csv", header=TRUE)
...
b1=gamm4(bmi ~ s(age),na.action=na.omit,  random = ~ (1|id), family=gaussian(link = "identity"), data=data1)  

b2=gamm4(bmi ~ s(age),na.action=na.omit,   random = ~ (1|id), family=gaussian(link = "identity"), data=data2)  
...
bmi_guts$var1_varying=(bmi_guts$p1-bmi_guts$bmi)^2
bmi_guts$var2_varying=(bmi_guts$p2-bmi_guts$bmi)^2
...
write.csv(class_2,file="normal_class_2.csv", na="", col.names =T, row.names=T)
...
class_pbmi=cbind(class_2[,2], p_bmi1_2[,2], p_bmi2_2[,2])

colnames(class_pbmi)=cbind("class","pbmi1","pbmi2")
...
jpeg('SMM_normal_2.png', width = 7, height = 7, units = 'in', res = 600)

par(mfrow=c(1,1))

plot(main="SMM_normal_2", out1_mean_avg$age, out1_mean_avg$pbmi_new, type="l", col="black", 
xlab="Time", ylab="Mean Y",ylim=range(-30, 40),  xlim=range(0, 1))
lines(out2_mean_avg$age,out2_mean_avg$pbmi_new, type="l", col="red")

legend(0, 40, legend=c("Group 1", "Group 2"),
...
b3=gamm4(bmi ~ s(age),na.action=na.omit,  random = ~ (1|id), family=gaussian(link = "identity"), data=data3)  
...
bmi_guts$var1_varying=(bmi_guts$p1-bmi_guts$bmi)^2
bmi_guts$var2_varying=(bmi_guts$p2-bmi_guts$bmi)^2
bmi_guts$var3_varying=(bmi_guts$p3-bmi_guts$bmi)^2
...
write.csv(class_3,file="normal_class_3.csv", na="", col.names =T, row.names=T)
...
class_pbmi=cbind(class_3[,2], p_bmi1_3[,2], p_bmi2_3[,2], p_bmi3_3[,2])

colnames(class_pbmi)=cbind("class","pbmi1","pbmi2","pbmi3")
...
jpeg('SMM_normal_3.png', width = 7, height = 7, units = 'in', res = 600)

par(mfrow=c(1,1))

plot(main="SMM_normal_3", out1_mean_avg$age, out1_mean_avg$pbmi_new, type="l", col="black", 
xlab="Time", ylab="Mean Y",ylim=range(-30, 40),  xlim=range(0, 1))

lines(out2_mean_avg$age,out2_mean_avg$pbmi_new, type="l", col="red")
lines(out3_mean_avg$age,out3_mean_avg$pbmi_new, type="l", col="green")

legend(0, 40, legend=c("Group 1", "Group 2", "Group 3"),
...
b4=gamm4(bmi ~ s(age),na.action=na.omit,  random = ~ (1|id), family=gaussian(link = "identity"), data=data4)  
...
bmi_guts$var2_varying=(bmi_guts$p2-bmi_guts$bmi)^2
bmi_guts$var3_varying=(bmi_guts$p3-bmi_guts$bmi)^2
bmi_guts$var4_varying=(bmi_guts$p4-bmi_guts$bmi)^2
...
write.csv(class_4,file="normal_class_4.csv", na="", col.names =T, row.names=T)
...
class_pbmi=cbind(class_4[,2], p_bmi1_4[,2], p_bmi2_4[,2], p_bmi3_4[,2],p_bmi4_4[,2])

colnames(class_pbmi)=cbind("class","pbmi1","pbmi2","pbmi3","pbmi4")
...
jpeg('SMM_normal_4.png', width = 7, height = 7, units = 'in', res = 600)

par(mfrow=c(1,1))

plot(main="SMM_normal_4", out1_mean_avg$age, out1_mean_avg$pbmi_new, type="l", col="black", 
xlab="Time", ylab="Mean Y",ylim=range(-30, 40),  xlim=range(0, 1))
...
legend(0, 40, legend=c("Group 1", "Group 2", "Group 3", "Group 4"),
...
b5=gamm4(bmi ~ s(age),na.action=na.omit,  random = ~ (1|id), family=gaussian(link = "identity"), data=data5)  
...
bmi_guts$var3_varying=(bmi_guts$p3-bmi_guts$bmi)^2
bmi_guts$var4_varying=(bmi_guts$p4-bmi_guts$bmi)^2
bmi_guts$var5_varying=(bmi_guts$p5-bmi_guts$bmi)^2
...
write.csv(class_5,file="normal_class_5.csv", na="", col.names =T, row.names=T)
...
class_pbmi=cbind(class_5[,2], p_bmi1_5[,2], p_bmi2_5[,2], p_bmi3_5[,2],p_bmi4_5[,2], p_bmi5_5[,2])

colnames(class_pbmi)=cbind("class","pbmi1","pbmi2","pbmi3","pbmi4","pbmi5")
...
jpeg('SMM_normal_5.png', width = 7, height = 7, units = 'in', res = 600)

par(mfrow=c(1,1))

plot(main="SMM_normal_5", out1_mean_avg$age, out1_mean_avg$pbmi_new, type="l", col="black", 
xlab="Time", ylab="Mean Y",ylim=range(-30, 40),  xlim=range(0, 1))
...
legend(0, 40, legend=c("Group 1", "Group 2", "Group 3", "Group 4", "Group 5"),
